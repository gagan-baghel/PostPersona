...
import { getSessionUserIdFromRequest, signOAuthState } from "@/lib/auth/session"
import { resolveLinkedInRedirectUri, setLinkedInOAuthNonceCookie } from "@/lib/social/linkedin-oauth"
...
export async function POST(request: Request) {
  try {
    ...
    setLinkedInOAuthNonceCookie(response, nonce)
    return response
  } catch (error) {
